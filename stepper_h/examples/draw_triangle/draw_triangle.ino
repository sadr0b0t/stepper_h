...
static void prepare_line2() {
    ...
    int steps_y = (150000.0 - sm_y.current_pos) / 7.5;
    int delay_y = 1000;
    int time_y = delay_y * abs(steps_y);
    
    //int steps_x = (50000.0 - 150000.0) / 7.5;
    int steps_x = (50000.0 - sm_x.current_pos) / 7.5;
...
static void prepare_line3() {
    ...
    int steps_y = (0.0 - sm_y.current_pos) / 7.5;
    int delay_y = 1000;
    int time_y = delay_y * abs(steps_y);
    
    //int steps_x = -50000.0 / 7.5;
    int steps_x = (0.0 - sm_x.current_pos) / 7.5;
...
void loop() {
    ...
    if(!stepper_is_cycle_running()) {
        ...
        if(next_line == 1) {
            ...
            Serial.println("Prepare line2: (150000,50000,20000) -> (50000,150000,20000)");
            prepare_line2();
            next_line = 3;
        } else if(next_line == 3) {
            Serial.println("Prepare line3: (50000,150000,20000) -> (0,0,0)");
            prepare_line3();
            next_line = 1;
        }
